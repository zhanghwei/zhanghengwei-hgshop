...
<body>
    ...
    <script src="resource/js/Particleground.js" type="text/javascript"></script>
    <script src="resource/Js/Treatment.js" type="text/javascript"></script>
    <script src="resource/js/jquery.mockjax.js" type="text/javascript"></script>
